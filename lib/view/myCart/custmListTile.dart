...
class _RenderListTile extends RenderBox {
  ...
  static const double _minLeadingWidth = 60.0;
  final double height;
  final double width;

  // The horizontal gap between the titles and the leading/trailing widgets
  static const double _horizontalTitleGap = 1.0;
  ...
  void performLayout() {
    ...
    final BoxConstraints newConstraints =
        looseConstraints.tighten(height: height, width: width);
    final double tileWidth = looseConstraints.maxWidth;
    final Size leadingSize = _layoutBox(leading, newConstraints);
